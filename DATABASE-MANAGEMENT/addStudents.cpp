...
string SchemaName = "bkj011"; // Change to your username
   ...
   //builder.append("<br><br><br> STUDENTS table before:" + myDB.query(query1) +"<br>");
   ...
   if(studentName.compare("") == 0 || studentMajor.compare("") == 0){
	   cout << "INVALID INPUT" << endl;
	   return 0;
   }

   // Get the next usable id
   string q = "select IFNULL(max(STUDENTID), 0) as max_id from STUDENTS";
   ...
   string input = "'" + to_string(next_id) + "','" + studentName + "','" + studentMajor + "'";
