...
<h3>See the list of jobs available in the database for a specifc major by choosing it in the dropdown menu below:</h3>
...
$Students = $myDb->query('SELECT DISTINCT DESIREDMAJOR FROM JOBS');
?>
...
if (isset($_POST['submit'])) 
{
    ...
    $command = '/home/bkj011/public_html/project_cpp/viewJobs.exe ' . $major;
